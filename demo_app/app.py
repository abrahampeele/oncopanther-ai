...
# Data-parsing and PDF generation — standalone module (no Streamlit dependency)
from report_generator import parse_pharmcat_results, parse_acmg_tsv, generate_pgx_pdf
...
_real_acmg_summary_file = _REAL_NA12878_OUTDIR / "annotation" / "acmg" / "PT-NA12878-001_oncoPanther_acmg_summary.json"
try:
